...
Technological innovations such as blockchain, AI, and IoT are fuelling progress towards Sustainable Development (SD) by enhancing traceability, widening financial access, and boosting transparency in corporate practices. These technologies are shaping how Environmental, Social, and Governance (ESG) priorities are incorporated into business operations and are becoming crucial drivers for integrating ESG principles into the strategic and operational frameworks of financial systems worldwide @saxena2023. Corporations are reshaping business strategies to align ESG with company performance @taskin2025. Recent disruption in artificial intelligence and machine learning (AI/ML) is likewise driving the ESG movement and serving as a strategic enabler of digital transformation and ESG implementation in organisations. By increasing transparency, maximising resource efficiency, and bolstering overall ESG performance, AI/ML readiness helps organisations achieve and enhance sustainable outcomes @saetra2023. To supplement existing sustainability standards, legal requirements, and internal operational procedures, the AI-ESG Protocol offers a high-level, flexible agenda @saetra2023. Organisations can use this protocol to identify strategic opportunities, address areas for development, and openly share ESG performance with stakeholders, investors, and markets @saetra2023. Organisations are moving beyond ESG impact analyses toward comprehensive strategies that synchronise AI deployment with best practices in governance, accountability, and sustainable development @holmstrom2022.

The ESG landscape is shifting rapidly. Non-governmental organisations, specialised consultancies, and advocacy groups focused on sustainability and social responsibility increasingly recognise its importance. ESG considerations are now entering sectors such as lodging, transportation, resource consumption, waste management, and cultural-heritage protection @back2024. The incorporation of ESG into investment decisions is also becoming more prevalent, largely driven by the growing importance of ESG ratings @clark2024. Global ESG assets are projected to reach \$40 trillion by 2030 @bloomberg2024. ESG is already a major driver in asset management: as of 2018, ESG integration alone accounted for roughly \$17.5 trillion in assets under management @gsia2018, nearly one-quarter of the \$74.3 trillion held by the global asset management industry @bcg2019.

Empirical studies often suggest that organisations that manage ESG risks proactively achieve stronger financial outcomes, including sturdier returns and lower portfolio volatility @friede2015. Prior work links ESG to metrics such as Pretax ROA and Pretax ROE and increasingly applies machine-learning models (decision trees, random forests, gradient boosting) to ESG–CFP questions. Results remain mixed, however. Limited evidence also exists on whether any ESG–CFP link in Asian BFSI is homogeneous across countries and business lines, or whether tree-based models retain predictive power once evaluated out of sample with firm-grouped folds. This study addresses that gap with a firm-year panel, two-way fixed-effects estimation (including country- and industry-group heterogeneity), and out-of-sample machine-learning checks, together with illustrative sector-trend projections. The research objectives are as follows.
...
Artificial intelligence and machine learning (AI/ML) present significant opportunities for exploring the ESG–CFP relationship. AI enables organisations to manage and analyse ESG data more effectively, streamline compliance processes, and implement sustainable strategies with greater precision @zeng2024. It is increasingly recognised as a critical strategic tool, providing businesses of all sizes with a competitive advantage and facilitating new avenues for growth @ferrigno2025. By leveraging AI, organisations can drive innovation, foster collaborative approaches, and enhance operational precision @daugherty2024. AI also supports the development of agile capabilities, allowing firms to optimise resource utilisation and improve overall efficiency @holmstrom2022. In the ESG context, AI can transform traditional processes by automating data collection, identifying inconsistencies, and delivering real-time insights, thereby enhancing the accuracy, timeliness, and reliability of ESG disclosures @mustafa2025. Improved transparency in reporting strengthens stakeholder trust and contributes to enhanced organisational performance on ESG criteria @saetra2023. Beyond reporting, AI is reshaping business models across sectors and driving the next generation of economic and social value creation @francisco2023. International organisations such as the United Nations and the World Economic Forum emphasise exploring AI to harness and advance sustainability objectives and to promote responsible, forward-looking industry practices @francisco2023. AI has transitioned from a speculative concept to a core element of strategic planning, influencing operations across business, healthcare, government, and other sectors worldwide @daugherty2024. By addressing tasks that are traditionally complex, resource-intensive, or creatively demanding, AI enhances productivity, efficiency, and performance across fields such as education, marketing, finance, and manufacturing @daugherty2024. As AI-driven solutions become more prevalent, they not only transform operational and manufacturing processes but also extend into functions historically performed by humans, supporting organisations in achieving ESG objectives through responsible innovation, efficiency, and ethical decision-making @daugherty2024. The growing adoption of AI thus creates substantial opportunities for advancing ESG and improving the quality and effectiveness of decision-making for all stakeholders @teichmann2024. By establishing robust AI-driven channels for engaging external stakeholders, organisations can enhance their appeal to ESG-focused investors and potentially realise improved financial returns @shahzad2020.

Interest in the intersection of ML and ESG within finance and accounting research has grown rapidly @li2025. The abundant availability of financial and accounting data, combined with the complex and often subtle interrelationships among key variables, makes these fields particularly well suited to ML @kelly2023. ML techniques in finance and accounting studies have expanded quickly, with an annual average of over 300 such papers published between 2020 and 2024 @li2025. The versatility of ML enables researchers to analyse extensive and unconventional datasets—ranging from job advertisements and earnings-call transcripts to media reports—with a depth and granularity not achievable through traditional approaches @li2025. By contrast, conventional asset pricing frameworks, such as the Capital Asset Pricing Model (CAPM) and the Fama–French three-factor model, rely on linear relationships between a limited set of risk factors and expected returns @kelly2023. These models assume that market dynamics are relatively stable and that factor–return relationships remain straightforward over time @ferrara2024. In practice, financial markets are far more complex, characterised by non-linear interactions, evolving relationships, and massive volumes of data, creating conditions in which ML offers significant advantages @khandani2010. @tab:esg-aiml-landscape summarises earlier studies on ESG and AI/ML research, while @tab:forecasting-models summarises the AI/ML models employed in this literature and their typical ESG–finance applications.
...
The specification is intentionally parsimonious: it includes no time-varying covariates such as firm size, leverage, or capital ratios. Firm fixed effects already absorb time-invariant confounders (for example business model, domicile, and ownership structure), and year fixed effects absorb common macro-financial shocks. In banking and financial services, many natural candidate controls are themselves tightly linked to pretax profitability—or may lie on the pathway from ESG to reported returns—so conditioning on them risks bad-control bias rather than cleaner identification of the ESG–CFP association. The baseline therefore estimates the within-firm ESG–profitability relationship after removing firm and year effects; sensitivity to additional time-varying controls is left to future work.
